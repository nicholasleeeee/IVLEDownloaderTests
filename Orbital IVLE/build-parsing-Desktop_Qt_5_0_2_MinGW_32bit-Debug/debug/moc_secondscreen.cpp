...
#include "../../parsingApiKey/secondscreen.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SecondScreen_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 35, 0)
    ...
    "SecondScreen\0on_pushButton_clicked\0\0"
};
...
void SecondScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SecondScreen *_t = static_cast<SecondScreen *>(_o);
        switch (_id) {
...
const QMetaObject SecondScreen::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SecondScreen.data,
      qt_meta_data_SecondScreen,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SecondScreen.stringdata))
        return static_cast<void*>(const_cast< SecondScreen*>(this));
