...
#include "../../IVLEDownloader/IVLEdownloader/announcementaction.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AnnouncementAction_t, stringdata) + ofs \
...
const QMetaObject AnnouncementAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_AnnouncementAction.data,
      qt_meta_data_AnnouncementAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AnnouncementAction.stringdata))
