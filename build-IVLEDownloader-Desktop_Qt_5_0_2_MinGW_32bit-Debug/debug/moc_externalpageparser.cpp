...
#include "../../IVLEDownloader/IVLEdownloader/externalpageparser.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ExternalPageParser_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 30, 6)
    ...
    "ExternalPageParser\0setConfig\0\0Config\0"
};
...
const QMetaObject ExternalPageParser::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ExternalPageParser.data,
      qt_meta_data_ExternalPageParser,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ExternalPageParser.stringdata))
