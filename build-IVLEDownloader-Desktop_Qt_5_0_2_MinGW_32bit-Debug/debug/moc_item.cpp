...
#include "../../IVLEDownloader/IVLEdownloader/item.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Item_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 33, 21)
    },
    "Item\0itemdeleted\0\0changeVal\0func\0"
...
void Item::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->itemdeleted((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->changeVal((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            typedef void (Item::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Item::itemdeleted)) {
                *result = 0;
            }
        }
        {
            typedef void (Item::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Item::changeVal)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Item::itemdeleted(QString _t1)
{
...
// SIGNAL 1
void Item::changeVal(QString _t1, int _t2)
{
