...
#include "../../IVLEDownloader/IVLEdownloader/lapi.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Lapi_t, stringdata) + ofs \
...
const QMetaObject Lapi::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Lapi.data,
      qt_meta_data_Lapi,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Lapi.stringdata))
